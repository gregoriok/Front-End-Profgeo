  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      <div className="max-w-lg mx-auto">
        ...
        {/* BOTÃO VOLTAR */}
        <div className="mb-6">
          <Link to="/unidades" className="text-gray-500 hover:text-blue-600 flex items-center gap-2 font-medium transition-colors w-fit">
        ...
        <div className="bg-white p-8 rounded-xl shadow-md border border-gray-200">
          <h2 className="text-2xl font-bold mb-6 text-gray-800">Nova Unidade Associada</h2>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input {...register("estado", { required: true, maxLength: 2 })} placeholder="RS" className="w-full p-2 border rounded focus:ring-2 focus:ring-blue-500 uppercase" />
                </div>
            </div>
            
            <div className="flex items-center gap-2 pt-2">
                <input type="checkbox" {...register("status")} defaultChecked={true} className="h-4 w-4 text-blue-600 rounded" />
